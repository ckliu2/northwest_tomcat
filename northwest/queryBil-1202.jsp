...
<%
System.out.println("jsp 2:"+com.base.util.Tools.getCurrentTimestamp());
%> 
<%--群組權限--%> 
...
<c:set var="i" value="0" />
<%
System.out.println("jsp 137:"+com.base.util.Tools.getCurrentTimestamp());
%> 
<display:table name="billdetail" class="list"  id="row" export="false" pagesize="${GLOBAL_pagesize}" sort="list" requestURI="queryBill.html" >
 ...
 <%--   
   ...
   <%--設定步驟1(完成時間)--%>
    ...
    <display:column title="${step1column}" class="results" sortable="false">
        ...
        <br><br>
        <a href="javascript:openChild('uploadStep1.html?${pageIndexName}=${pageIndex}')"  ><img src="images/edit.gif" border=0></a>         
    ...
    <ww:if test="${ck5} == true">
     ...
     <display:column title="${step5column}" class="results" sortable="false">
          ...
          <ww:else>
           ...
           <a href="javascript:openChild('uploadStep5.html?${pageIndexName}=${pageIndex}')"  onclick="return ${isLinkEnable}"><img src="images/edit.gif" border=0></a>     
        <br><br>
    ...
    <ww:if test="${ck6} == true">
     ...
     <display:column title="${step6column}" class="results" sortable="false">
        ...
        <a href="javascript:openChild('uploadStep6.html?${pageIndexName}=${pageIndex}')"  onclick="return ${isLinkEnable}"><img src="images/edit.gif" border=0></a>     
       <br><br>
    ...
    <display:column title="${step7column}" class="results" sortable="false">
       ...
       <a href="javascript:openChild('uploadStep7.html?${pageIndexName}=${pageIndex}')"  onclick="return ${isLinkEnable}"><img src="images/edit.gif" border=0></a>         
   ...
   <%--設定步驟8(後製時間)--%>
    ...
    <display:column title="${step8column}" class="results" sortable="false">
       ...
       <ww:if test="${Permissions8} == true">
        ...
        <a href="javascript:openChild('uploadStep8.html?${pageIndexName}=${pageIndex}')"  onclick="return ${isLinkEnable}"><img src="images/edit.gif" border=0></a>   
         <br><br>
    ...
    <ww:if test="${ck11} == true">
     ...
     <display:column title="${step11column}" class="results" sortable="false">
       ...
       <ww:if test="${Permissions11} == true">
        ...
        <a href="javascript:openChild('uploadStep11.html?${pageIndexName}=${pageIndex}')" onclick="return ${isLinkEnable}"><img src="images/edit.gif" border=0></a>     
...
<%
System.out.println("jsp 515:"+com.base.util.Tools.getCurrentTimestamp());
%>  
...
<%
System.out.println("jsp 598:"+com.base.util.Tools.getCurrentTimestamp());
%>  