...
if (false) {
      ...
      out.write("\t  <input name=\"keyword\" id=\"keyword\" class=\"easyui-textbox\" data-options=\"prompt:'輸入訂單、其他訂單、條碼編號、貨運公司、收件人、寄件人'\" style=\"width:400px\" />\r\n");
      out.write("\t  \r\n");
      ...
      out.write("\t  <a href=\"#\" class=\"easyui-linkbutton\" iconcls=\"icon-excel\" plain=\"true\" onclick=\"excel()\">匯入</a>      \r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      ...
      out.write(" \tvar freights=getSelPrintFreight();\r\n");
      out.write(" \tvar divs = jQuery.unique(getSelPrint()); \t\r\n");
      out.write(" \tvar c=consecutive(getSelCode());\r\n");
      out.write(" \t\r\n");
      out.write(" \tif(divs.length>1){\r\n");
      out.write(" \t\t$.messager.alert('系統訊息', '一次只能選取一個貨運公司列印!', 'error');\r\n");
      out.write("    return false;\r\n");
      out.write(" \t}\r\n");
      out.write(" \t\r\n");
      out.write(" \tif(c===false){\r\n");
      out.write(" \t\t$.messager.alert('系統訊息', '列印必須是連號!', 'error');\r\n");
      out.write("    return false;\r\n");
      out.write(" \t}\r\n");
      out.write(" \t\r\n");
      out.write(" \tif(divs.toString()==='其他'){\r\n");
      out.write(" \t\t$.messager.alert('系統訊息', '其他貨運公司不能列印!', 'error');\r\n");
      out.write("    return false;\r\n");
      out.write(" \t}\r\n");
      out.write(" \t\r\n");
      out.write(" \t\r\n");
      ...
      out.write("\t\t    {\r\n");
      out.write("\t\t\t    window.open(pdfUrl);\t\t\t  \r\n");
      out.write("\t\t    }\r\n");
      out.write("    });    \r\n");
      out.write("  //alert(purl);  \r\n");
      out.write(" \t//window.open(purl);\r\n");
      out.write(" }  \r\n");
      out.write(" \r\n");
      out.write(" \r\n");
      out.write(" \r\n");
      ...
      out.write(" \t/*\r\n");
      out.write(" \t$('#myevent2').window('open');\r\n");
      out.write("  $('#myevent2').window('setTitle', '匯入快遞單'); \r\n");
      out.write("  $('#myevent2').window('refresh', 'logisticsExcel.html');    \r\n");
      out.write("  */\r\n");
      out.write("  window.open('logisticsExcel.html');\t\r\n");
      out.write(" }\r\n");
      out.write(" \r\n");
      out.write(" \r\n");
      ...
      out.write("            }\r\n");
      out.write(" \r\n");
      out.write("  function getSelCode() {\r\n");
      out.write("                var checkedItems = $('#dg').datagrid('getChecked');\r\n");
      out.write("                var names = [];\r\n");
      out.write("                $.each(checkedItems, function(index, item) {\r\n");
      out.write("                    names.push(item.code);\r\n");
      out.write("                    names.join(\",\");\r\n");
      out.write("                });\r\n");
      out.write("                return names;\r\n");
      out.write("            }\r\n");
      out.write(" \r\n");
      out.write(" function getSelPrintFreight() {\r\n");
      out.write("                var checkedItems = $('#dg').datagrid('getChecked');\r\n");
      out.write("                var names = [];\r\n");
      out.write("                $.each(checkedItems, function(index, item) {\r\n");
      out.write("                    names.push(item.freightRPT);\r\n");
      out.write("                    names.join(\",\");\r\n");
      out.write("                });\r\n");
      out.write("                return names;\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write(" function getSelPrint() {\r\n");
      out.write("                var checkedItems = $('#dg').datagrid('getChecked');\r\n");
      out.write("                var names = [];\r\n");
      out.write("                $.each(checkedItems, function(index, item) {\r\n");
      out.write("                    names.push(item.freight);\r\n");
      out.write("                    names.join(\",\");\r\n");
      out.write("                });\r\n");
      out.write("                return names;\r\n");
      out.write("            }\r\n");
      out.write(" \r\n");
      out.write(" \r\n");
      out.write("  function getSelBillNo() {\r\n");
      out.write("                var checkedItems = $('#dg').datagrid('getChecked');\r\n");
      out.write("                var billno = '';\r\n");
      out.write("                $.each(checkedItems, function(index, item) {\r\n");
      out.write("                    billno=item.billno;\r\n");
      out.write("                });\r\n");
      out.write("                return billno;\r\n");
      out.write("            }\r\n");
      out.write(" \r\n");
      out.write("            \r\n");
      out.write("            \r\n");
      out.write("function consecutive(codes) {\r\n");
      out.write(" //alert('codes.length='+codes.length);\t\r\n");
      out.write(" var codes=codes.sort();\r\n");
      out.write(" for (var j = 0; j < codes.length - 1; j++) {\r\n");
      out.write(" \tvar c=codes[j + 1]-codes[j];\r\n");
      out.write(" \tif(c>1)\treturn false;\r\n");
      out.write(" }\r\n");
      out.write(" return true;\r\n");
      out.write("}\r\n");
      out.write("                        \r\n");
