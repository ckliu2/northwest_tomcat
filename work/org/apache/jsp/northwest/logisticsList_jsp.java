...
if (false) {
      ...
      out.write("\t  <input name=\"keyword\" id=\"keyword\" class=\"easyui-textbox\" data-options=\"prompt:'輸入訂單、其他訂單、條碼編號、貨運公司'\" style=\"width:400px\" />\r\n");
      out.write("\t  \r\n");
      ...
      out.write("  var purl='http://127.0.0.1:8888/?'+freights.toString()+'&id='+id;\r\n");
      out.write("  \r\n");
