...
<display:table name="billdetail" class="list"  id="row" export="false" pagesize="${GLOBAL_pagesize}" requestURI="editBill.html" sort="list"  partialList="true" size="${RESULT_SIZE}">
    ...
    <display:column title="${step1column}" class="results" sortable="true">
        ...
        <a href="javascript:openChild('uploadStep1.html?bill.id=${bill.id}&${pageIndexName}=${pageIndex}')"  ><img src="images/edit.gif" border="0" id="${schedule.id}-edit-1"></a>         
    ...
    <ww:if test="${ck5} == true">
     ...
     <display:column title="${step5column}" class="results" sortable="true">
       ...
       <a href="javascript:openChild('uploadStep5.html?bill.id=${bill.id}&${pageIndexName}=${pageIndex}')"  onclick="return ${isLinkEnable}"><img src="images/edit.gif" border="0" id="${schedule.id}-edit-5" ></a>     
    ...
    <ww:if test="${ck6} == true">
     ...
     <display:column title="${step6column}" class="results" sortable="true">
        ...
        <a href="javascript:openChild('uploadStep6.html?bill.id=${bill.id}&${pageIndexName}=${pageIndex}')"  onclick="return ${isLinkEnable}"><img src="images/edit.gif" border="0" id="${schedule.id}-edit-6" ></a>     
    ...
    <display:column title="${step7column}" class="results" sortable="true">
       ...
       <a href="javascript:openChild('uploadStep7.html?bill.id=${bill.id}&${pageIndexName}=${pageIndex}')"  onclick="return ${isLinkEnable}"><img src="images/edit.gif" border="0" id="${schedule.id}-edit-7" ></a>         
   ...
   <%--設定步驟7(輸出)--%>
    ...
    <display:column title="${step8column}" class="results" sortable="true">
       ...
       <ww:if test="${Permissions8} == true">
        ...
        <a href="javascript:openChild('uploadStep8.html?bill.id=${bill.id}&${pageIndexName}=${pageIndex}')"  onclick="return ${isLinkEnable}"><img src="images/edit.gif" border="0" id="${schedule.id}-edit-8" ></a>   
    ...
    <ww:if test="${ck11} == true">
     ...
     <display:column title="${step11column}" class="results" sortable="true">
       ...
       <ww:if test="${Permissions11} == true">
        ...
        <a href="javascript:openChild('uploadStep11.html?bill.id=${bill.id}&${pageIndexName}=${pageIndex}')" onclick="return ${isLinkEnable}"><img src="images/edit.gif" border="0" id="${schedule.id}-edit-11" ></a>     
    ...
    <display:column title="${step12column}" class="results" sortable="true">
      ...
      <a href="javascript:openChild('uploadStep12.html?bill.id=${row.bill.id}&billSchedule.billDetailId=${schedule.billDetail.id}&${pageIndexName}=${pageIndex}')" onclick="return ${isLinkEnable}"><img src="images/edit.gif" border="0" id="${schedule.id}-edit-12"></a>                 
