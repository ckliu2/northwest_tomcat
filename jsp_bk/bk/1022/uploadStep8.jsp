...
<ww:form name="Form1" action="saveCheck8" method="POST" onsubmit="onSubmit()" >
   ...
   <table border="0" cellspacing="1" class="cContentTable1">
    ...
    <tr><td class="cInputCaption"><fmt:message key="billSchedule.productionTime"/></td>
        <td class="cInputColumn">
            <ww:textfield  name="productionTime" id="productionTime"  readonly="true" />
            <a href="javascript: NewCssCal('productionTime','yyyymmdd','arrow',true)">
