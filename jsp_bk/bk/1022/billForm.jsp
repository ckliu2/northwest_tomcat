...
<display:table name="billdetail" class="list"  id="row" export="false" pagesize="${GLOBAL_pagesize}" sort="list">
    ...
    <%--
    <display:column property="fromRow" sortable="false" titleKey="billdetail.fromRow" /> 
    --%>  
    ...
    <%--
    <display:column property="price" sortable="false" titleKey="billdetail.price" />
    <display:column property="product.unit" sortable="false" titleKey="product.unit" />
    <display:column property="width" sortable="false" titleKey="billdetail.width" />
    <display:column property="heigh" sortable="false" titleKey="billdetail.heigh" />
    <display:column property="calcArea" sortable="false" titleKey="billdetail.calcArea" />
    <display:column property="visibleWidth" sortable="false" titleKey="billdetail.visiblewidth" />    
    <display:column property="visibleHeigh" sortable="false" titleKey="billdetail.visibleheight" />    
    <display:column property="area" sortable="false" titleKey="billdetail.area" style="text-align:left" />
    <display:column property="quantity" sortable="false" titleKey="billDetail.quantity" style="text-align:left" />
    <display:column property="detail" sortable="false" titleKey="billDetail.detail" style="text-align:left" />
    <display:column property="itemRemark" sortable="false" titleKey="billDetail.itemRemark" style="text-align:left" />
    <display:column property="paperPrice" sortable="false" titleKey="billDetail.paperPrice" style="text-align:left" />
    <display:column property="amount" sortable="false" titleKey="billDetail.amount" style="text-align:left" />
    --%>
   ...
   <%--設定步驟7(輸出)--%>
    ...
    <display:column title="${step12column} <input type='checkbox' name='selectall12' onClick='javascript:selectAll(12);' ${selectPower12} />" class="results" sortable="false">
      ...
      <a href="javascript:openChild('uploadStep12.html?bill.id=${bill.id}&billSchedule.billDetailId=${schedule.billDetail.id}')" onclick="return ${isLinkEnable}"><img src="images/edit.gif" border=0></a>                 
      <br><br>
