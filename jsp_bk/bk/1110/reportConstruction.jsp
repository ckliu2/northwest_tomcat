  ...
  <tr>
    <td colspan="2" align="center" valign="middle" class="cInputCaption1">
      ...
      <div align="left"> 
        ...
        <fmt:message key="billdetail.size"/> :${row.billDetail.width}(<fmt:message key="billdetail.width"/>) &nbsp; &nbsp; ${billSchedule.billDetail.visibleWidth}(<fmt:message key="billdetail.visiblewidth"/>)<BR>
