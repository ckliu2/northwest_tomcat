...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/css/site-demos.css">


    <script src="${ctx}/scripts/jquery.validate.min.js"></script>
    <script src="${ctx}/scripts/additional-methods.min.js"></script>
